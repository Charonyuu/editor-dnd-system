    ...
    return (
        <div className='w-screen h-screen flex flex-col justify-center items-center'>
            <div className='bg-black border-white border border-solid rounded-xl p-10 flex flex-col items-center'>
                ...
                <Input className='w-full my-2' type='text' placeholder="Account or ProjectId" value={account} onChange={(e) => setAccount(e.target.value)} />
                <Input className='w-full my-2' type='password' placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
