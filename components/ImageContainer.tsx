...
export default function ImageContainer({ id, index, item, setItems }: AddImageProps) {
    ...
    return (
        <div className='w-[200px] h-[200px] bg-gray-500 rounded-lg relative overflow-hidden cursor-pointer my-2 mr-2' onClick={() => imageInputRef.current?.click()}>
            ...
            <div className='absolute bottom-[10px] left-1/2 -translate-x-1/2 ' onClick={(e) => {
                e.stopPropagation()
            }}><Dialog>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input value={url} onChange={(e) => setUrl(e.target.value)} id="url" placeholder='輸入網址' className="col-span-3" />
                            </div>
                        </div>
                        <DialogFooter>
                            <DialogClose asChild>
